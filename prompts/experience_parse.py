...
5. "others" 字段用于存储不属于教育/工作/项目/技能/获奖的零散信息：证书、语言能力、培训经历、资格认证、兴趣爱好、志愿服务、校园经历/学生组织/社团活动（如"校学生会宣传部部长"，content 写时间、职责与成果）等。每条用 title 概括标题（如"CET-6英语六级"），content 写具体内容（时间、分数、说明等）。
